...
import { TYPE_GROUPS } from '../model/exerciseTypeGroups';
import { groupHue } from './WorkoutRow';
import { renderTimelineSection } from './TimelineSection';
...
export class DashboardView extends ItemView {
	...
	private async doRender(): Promise<void> {
		...
		renderTimelineSection(canvas, workouts, this.plugin.settings.menus, (date, idx, entry: WorkoutEntry) =>
			this.openEditModal(date, idx, entry)
		);
